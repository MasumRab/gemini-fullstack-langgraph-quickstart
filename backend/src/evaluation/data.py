...
def download_benchmark_data(output_dir: str = "data/benchmark"):
    ...
    try:
        ...
        has_requests = False
        logger.warning(
            "Requests library not found, skipping download and creating mock data."
        )
        ...
        mock_data = [
            {
                ...
                "key_facts": [
                    {
                        "fact": "AI diagnostic accuracy exceeds 90% in radiology",
                        "source": "nejm.org",
                    },
                    {
                        "fact": "FDA approved 50+ AI diagnostic tools since 2020",
                        "source": "fda.gov",
                    },
                ],
            ...
            },
            {
                ...
                "key_facts": [
                    {
                        "fact": "Lithium-ion costs dropped 90% since 2010",
                        "source": "bloomberg.com",
                    },
                    {
                        "fact": "Grid-scale storage capacity reached 20GW globally",
                        "source": "iea.org",
                    },
                ],
